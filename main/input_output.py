class observation(object):
    def __init__(self, myhp=0, mybullet=0, myheat=0, myfire=0,
                 ...
                 mylinearvel_x=0, mylinearvel_y=0, myanglevel=0,
        ...
        self.mylinearvel_x = mylinearvel_x
        self.mylinearvel_y = mylinearvel_y
    ...
    def get_observation(self):
        return [self.myhp, self.mybullet, self.myheat, self.myfire,
                ...
                self.mytheta, self.mylinearvel_x, self.mylinearvel_y, self.myanglevel,
