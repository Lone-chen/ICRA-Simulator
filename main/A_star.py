...
class map_2d:
    def __init__(self):
        self.height = 808  # 地图横向长度
        self.width = 448  # 地图纵向长度
        self.data = []  # 存放地图信息,初始化全部为0
        self.barrier_start = ([0, 100], [150, 214], [150, 348], [354, 94], [354, 335], [638, 0], [578, 214],
                              [708, 328])  # 障碍物左上角坐标(B1-B4,B6-B9)
        self.barrier_end = ([100, 120], [230, 234], [170, 448], [454, 114], [454, 355], [658, 100], [658, 234],
                            [808, 348])  # 障碍物右上角坐标(B1-B4,B6-B9)
...
##建图并设立障碍
ss=map_2d()
ss.map_initialization()
ss.map_barriers()
start_point = Point(1,2)
end_point = Point(2,19)
